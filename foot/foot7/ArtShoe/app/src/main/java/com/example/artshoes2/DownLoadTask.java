...
public class DownLoadTask extends AsyncTask<String, Integer, Integer> {
    ...
    protected Integer doInBackground(String... strings) {
        ...
        try {
            ...
            if(UserInformation.downloadid==1)directory = CreatePdfFolder();//当前要放脚型txt的地址
            else if(UserInformation.downloadid==2)directory = CreateObjFolder();
            ...
            if (response != null) {
                ...
                while ((len = inputStream.read(bytes)) != -1) {
                    if (isCanceled) {
                        ...
                        UserInformation.downloadprogress=progress;
