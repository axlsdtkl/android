...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernamelength=username.getText().toString().trim().length();
        pswlength=password.getText().toString().trim().length();
        ...
        buttonlogin=(Button)findViewById(R.id.button_register);
        buttonlogin.setEnabled(false);
